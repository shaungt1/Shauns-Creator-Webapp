class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div  class="col-lg-6 col-sm-12 my-2 mx-3 ">
        <div id="latest-bg"></div>
        <div><p>Check out the latest video here!</p></div>
        </div>
       
        <!-- Right side video callout-->
        <div class="col-lg-6 col-sm-12 my-2 mx-3"><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="500px"  frameborder='0' allowfullscreen /></div>
        </div>
