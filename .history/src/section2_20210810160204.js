          ...
          <div class="col">
            ...
            <!--Add Icon -->
              <div class="card-body">
                ...
                <br>
                <br>
                <code class="py-4 card-text typewriter"><span class="Mkd"><</span><span class="Mkd">div</span><span class="Mkd">></span> Don't miss out any of the latest releases of free courses, code, hackathons, contest, videos, and Free stuff sign up below. 
