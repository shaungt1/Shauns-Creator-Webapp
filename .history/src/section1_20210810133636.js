class Section1 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="container1">
            ...
            <!-- Call to action -->
            <div style="margin-left:25%!important; margin-right:25%!important; " class=" text-center bg-dark card mx-5 px-4 py-4 mt-5 ">
            <a href="#connect" alt="shaun pritchard live webapp">
            <button class="btn btn-C1">Connect with me</button>
            </div>
            </a>
