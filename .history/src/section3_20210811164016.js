class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="row ">
        <div class="col-sm col-lg-4 py-3 px-3 mx-5 card dark-bg" id=""></div>
        <div class="col-sm col-lg-4 py-3 px-3 mx-5 card dark-bg" id=""></div>
        <div class="col-sm col-lg-4 py-3 px-3 mx-5 card dark-bg" id=""></div>
        <div class="col-sm col-lg-4 py-3 px-3 mx-5 card dark-bg" id=""></div>
        </div>
        ...
        <div id="latest-bg" class="col-sm-12 col-lg-6 d-flex"></div>
        <!-- Right side video callout-->
        <div id="ri" class="col-sm-12 d-flex col-lg-6"><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="100%"  frameborder='0' allowfullscreen /></div>
        </div>
