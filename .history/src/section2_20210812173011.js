              ...
              <div class="card-body">
                ...
                <!-- Button row-->
                    <div class="row py-5 text-center">
                        ...
                        <form action="/contact/#wpcf7-f279-p33-o1" method="post" class=" d-flex wpcf7-form init" novalidate="novalidate" data-status="init">
                        ...
                        <p><label> Your email<br>
                            <span class=" mt-5 mx-4 wpcf7-form-control-wrap your-email"><input type="email" name="your-email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false"></span> </label></p>
                        <p><input type="submit" value="Submit" class="btn-C1 btn wpcf7-form-control wpcf7-submit"><span class="ajax-loader"></span></p>
