class Section1 extends HTMLElement {
    constructor() {
      super();
        // THIS IS WHERE ALL THE MAGIC HAPPENS/* te */
        ...
        //  Parallax elements with mouse only
        function parallax(e) {
        ...
        //  Dispatch touch event for tablets and mobile devices
    ...
    connectedCallback() {
        this.innerHTML = `
        <div class="bg1" style="width: 100% !important;">
        <div class="container1">
            <div class="row-85">
            <!-- Centered text -->
            <div class="text-center">
                <div class="object" data-value="0.85" id="signature"> </div>
            <h2 class="object D3vSl" data-value="3">Develop<br> <span>Your {Code} Skills</span></h2>
            <!-- Call to action -->
            <div class="Hm01 text-center dark-bg shadow-lg shadow card mx-5 px-4 py-4 mt-5 ">
            <!-- text highlight-->
            ...
            <!--Call to action section 1 a href button-->
            <div class="mt-5">
            <a class="btn btn-lg btn-C1 px-5" href="https://shaunp.live/course/" alt="shaun pritchard live web application">
            Check Out New Content & Courses
            </a>
            </div>
            </div>
            </div>
            <!--Left Column Section of parallax elements  -->
            <div class="col">
