...
<!--Row 1 pick your path section-->
      ...
      <hr/>
        ...
        <div class="col-6 card dark-bg mx-1 ">

          One of two columns
        </div>
        <div class="col-6  card dark-bg">
          One of two columns
          <iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="500px"; frameborder='0' allowfullscreen />
        </div>
      </div>
