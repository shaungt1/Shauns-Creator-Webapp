class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div id="latest-bg" class="col "></div>
        <div class="col "></div>
        <!-- Right side video callout-->
        <div class="col"><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="100%"  frameborder='0' allowfullscreen /></div>
        </div>
