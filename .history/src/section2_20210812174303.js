              ...
              <div class="card-body">
                ...
                <!-- Button row-->
                    <div class="row py-5 text-center">
                        <div class="col-sm-6">
                        <span class="col-6 d-flex justify-content-center text-center">Subscribe to Shaun's Newsletter</span>
                        <br/>
                        <span class="col-6 d-flex justify-content-center text-center">Dev Tutorials and News Delivered to Your Inbox!</span>
