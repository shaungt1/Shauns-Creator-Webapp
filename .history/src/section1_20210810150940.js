class Section1 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="container1">
            ...
            <h2 class="object" data-value="3">Hack<br> <span>Your Code Carrier</span></h2>
            <!-- Call to action -->
            <div style="margin-left:30%!important; margin-right:30%!important; " class=" text-center bg-dark card mx-5 px-4 py-4 mt-5 ">
            
            <h3 class="text-white">Whether you want to become a software engineer, a hacker, Data Scientist or just want to know how to get started in Code and AI, you’ve come to the right place.</h3>
