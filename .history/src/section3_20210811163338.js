class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div id="ri" class=""><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="100%" padding-top: 100%; frameborder='0' allowfullscreen /></div>
        </div>
