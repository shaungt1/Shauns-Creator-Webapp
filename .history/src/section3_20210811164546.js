class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="row ">
        <div class="col card dark-bg" id=""></div>
        <div class="col card dark-bg" id=""></div>
        <div class="col card dark-bg" id=""></div>
        <div class="col card dark-bg" id=""></div>
        </div>
        ...
        <div id="latest-bg" class="col mx-3 "></div>
       
        <!-- Right side video callout-->
        <div class="col mx-3"><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="100%"  frameborder='0' allowfullscreen /></div>
        </div>
