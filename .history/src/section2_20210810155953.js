          ...
          <div class="col">
            ...
            <!--Add Icon -->
              <div class="card-body">
                ...
                <br>
                <br>
                <code class="py-4 card-text"><span class="Mkd">`<div>`</span>Don't miss out any of the latest releases of free courses, code, hackathons, contest, videos, and Free stuff sign up below. 
