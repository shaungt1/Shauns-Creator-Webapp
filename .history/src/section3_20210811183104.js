      ...
      <!--VIDEO SECTION-->
       ...
       <!--Latest video section-->
        <div class="row  my-5 text-center justify-content-center">
            ...
            <div class="col-5 mx-1 py-3 card dark-bg"><iframe width="100%" height="450" src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' frameborder='0' allowfullscreen ></iframe></div>
        </div>
     </div>
