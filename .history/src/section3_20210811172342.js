...
<!--Row 1 pick your path section-->
        ...
        <div class="align-items-center px-3 py-3 mx-2  my-2 col col-sm-12  dark-bg" id="">1</div>
        <div class="align-items-center px-3 py-3 mx-2 my-2 col col-sm-12  dark-bg" id="">2</div>
        <div class="align-items-center px-3 py-3 mx-2 my-2 col col-sm-12  dark-bg" id="">3</div>
        <div class="align-items-center px-3 py-3 mx-2 my-2 col col-sm-12  dark-bg" id="">4</div>
        </div>
        </div>
