              ...
              <div class="card-body">
                ...
                <!-- Button row-->
                    <div class="row py-5 text-center">
                        ...
                        <div class="col-sm-6"> <small>Join the Patreon channel here!</small> <a href="https://shaunp.live/sign-up"class=""><div class="rounded mx-auto d-block" id="patreon"></div></a></div> 
                    </div>
              </div>
            </div>
          </div>
