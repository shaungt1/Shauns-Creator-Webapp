class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <!--Choose your path row-->
        <div class="text-center row-lg-12 row-sm-12">
        <!left col 1-->
        <div class="py-3 px-3 col-sm-3"></div>
        <!-- center-->
        <div class="py-3 px-3 col-sm-6">
        ...
        <div class="g-col-6 g-col-md-4"><span id="P2"></span></div>
        <div class="g-col-6 g-col-md-4"><span id="P3"></span></div>
        <div class="g-col-6 g-col-md-4"><span id="P4"></span></div>
        </div>
