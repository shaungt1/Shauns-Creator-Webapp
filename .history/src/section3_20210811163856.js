class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div id="latest-bg" class="col-sm-12 d-flex"></div>
        <!-- Right side video callout-->
        <div id="ri" class="col-sm-12 d-flex"><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="80em" padding-top: 100%; frameborder='0' allowfullscreen /></div>
        </div>
