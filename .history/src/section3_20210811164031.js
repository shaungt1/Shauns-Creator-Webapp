class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div id="latest-bg" class="col-sm-12 col-lg-6 "></div>
        <!-- Right side video callout-->
        <div id="ri" class="col-sm-12 col-lg-6"><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="100%"  frameborder='0' allowfullscreen /></div>
        </div>
