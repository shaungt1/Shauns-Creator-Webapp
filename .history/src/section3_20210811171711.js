...
<!--Row 1 pick your path section-->
        ...
        <div class="px-3 py-3  my-2 col-lg-3 col-sm-12  dark-bg" id="">1</div>
        <div class="px-3 py-3  my-2 col-lg-3 col-sm-12  dark-bg" id="">2</div>
        <div class="px-3 py-3  my-2 col-lg-3 col-sm-12  dark-bg" id="">3</div>
        <div class="px-3 py-3 my-2 col-lg-3 col-sm-12  dark-bg" id="">4</div>
        </div>
