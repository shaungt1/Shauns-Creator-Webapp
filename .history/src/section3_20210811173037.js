...
<!--Row 1 pick your path section-->
        ...
        <div class="row text-center my-4">
            ...
            <div  class="col my-2 card "></div>
            <!--left image-->
            <!-- Right side video callout-->
            <div class="col card dark-bg > <iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' frameborder='0' allowfullscreen />
            </div>
        </div>
