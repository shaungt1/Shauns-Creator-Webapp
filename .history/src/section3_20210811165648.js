class Section3 extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="col-lg-6 col-sm-12 my-2 card bg-dark ><iframe src='https://www.youtube.com/embed/?listType=playlist&list=UU78cpbnaq-eeKGGHIEtUgdw' width="100%" height="300px"  frameborder='0' allowfullscreen /></div>
        </div>
